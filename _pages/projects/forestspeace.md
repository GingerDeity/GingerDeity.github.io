...
## What It Is
Forest's Peace is the result of a semester-long group project for a class, a 2D top-down pixel art game that strives to teach the difficult balance of sustainability, where you have to balance gathering resources with conservation. Your town is always on the brink of collapsing, but if you cut too many trees without replanting, then the world will suffer, and there will be fewer animals. However, if you cut down too few, your village suffers and everything crumbles.
...
My Role was primarily as a backend programmer, and I was mainly responsible for:
...
- Implementing the dog's ability to scout and dig up seeds
- Performed and added the background music
- Set up data flow between UI, player inventory, and world state

## Development
### Milestone 1 (Week 4)
This was the first presentation we had to give as a group, and was more expected to be a proposal of our goals, rather than any concrete prototype. As you can tell from our slides below, we had very high ambitions... too high in the end. We were essentially hoping for a 2D platformer with an RPG story and peppered with randomly generated puzzle minigames, and maybe some combat, all done in the span of < 4 months.
...
### What I Learned
- This was actually my first ever completed Unity project! I had been using either GameMaker Studio or Godot for the past few years and completely missed the Unity hype. I got much more comfortable with the engine and C# as a result
- How to better work with a team, and learning to let go of control for the areas I wasn't in charge of
...
### What Worked
- The atmosphere was beautiful, and I think the art and sound design are really nice
...
- Start with a clearer and simpler vision for the project
- Certain collisions just... don't work. There are instances where the player could walk over water, etc
- Make it so that houses would spawn too! Only trees regrow, but I wanted to have the village also grow and expand. So, the better you took care of the village, the further destroyed the forest became

### Takeaway
This is a project that took a lot of time and effort, and while the end product is only a shadow of our original vision, I'm proud of how our team was able to pivot and produce something actually functional. If we had been able to have a clearer vision at the start, we would've saved so many headaches!

## Play & Explore
[Link to GitHub](https://github.com/anniexena/THE-GAME)
Includes a link to download in the readme, and controls are explained in the game
