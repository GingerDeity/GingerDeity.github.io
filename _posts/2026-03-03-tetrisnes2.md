...
In my last post, I mentioned how I was still deciding between using an already decompiled version of the game, rather than making my own. Since then, I messed around with an [already decompiled Tetris ROM](https://github.com/CelestialAmber/TetrisNESDisasm), and have quickly decided to pursue finishing the original project with this decompilation!
