...
Now, to be completely honest, the initial implementation of pendulum physics was done with ChatGPT, but I made sure to take the time to fully understand every line and its reasoning. I was even able to improve on the original responses I got from the AI, and am much more confident in my game-dev skills as a result.
...
- Handling rope collisions
  - What do we do when we're swinging, and an object comes into collision with our rope? We need to be destroying/retracting the rope when that happens, but how should we implement that?
