...
In our original school project, my teammate focused on adding wallkicks, while I was given the task of adding the new rotations. Quite simply, I want to be able to finish what I started by adding in the missing rotations while not sacrificing any blocks from the game. I've also recently been inspired by [other hacks](https://www.reddit.com/r/Tetris/comments/1dceffg/nes_tetris_with_hard_drop_ghost_piece_7digit/) I've seen for this game, so I may end up adding other mechanics too!

For the time being however a final hack will:
- add in the missing rotations for the I, S, and Z blocks
- be able to update the score and statistics in the game properly

There were also several difficulties with the development environment we used, which I plan on also fixing.
